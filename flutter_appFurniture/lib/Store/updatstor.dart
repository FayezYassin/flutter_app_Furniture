...
class UpdetstorScreen extends StatefulWidget {
  bool issaved;
  int indexitem;
  Storemodel storupdat;
  UpdetstorScreen(
      {required this.issaved,
      required this.storupdat,
      required this.indexitem});

  @override
  _UpdetstorScreenState createState() => _UpdetstorScreenState(
      ischos_save: issaved, storupdat: storupdat, index: indexitem);
}

class _UpdetstorScreenState extends State<UpdetstorScreen> {
  File? pickedImage;
  bool ischos_save;
  int index;
  Storemodel storupdat;
  _UpdetstorScreenState(
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<Cubitapp, Statesapp>(
        ...
        builder: (context, stat) {
          ...
          // print('object:  ${storupdat.namesala}');
          print('object:  $index');
          controlername.text = storupdat.namestor;
          controleremail.text = storupdat.emilestor;
          controlertitle.text = storupdat.titlestor;
          controlerpassword.text = storupdat.passwordstor;
          return Scaffold(
            appBar: AppBar(
              centerTitle: true,
