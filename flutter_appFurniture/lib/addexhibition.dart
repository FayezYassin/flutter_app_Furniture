...
class Addexhibition extends StatefulWidget {
  bool issaved;
  int? indexitem;
  Addexhibition({required this.issaved, this.indexitem});

  @override
  _AddexhibitionState createState() =>
      _AddexhibitionState(ischos_save: issaved, index: indexitem);
}
...
class _AddexhibitionState extends State<Addexhibition> {
  ...
  bool ischos_save;
  int? index;
  _AddexhibitionState({required this.ischos_save, this.index});
    ...
    return BlocConsumer<Cubitapp, Statesapp>(
        ...
        builder: (context, stat) {
          ...
          return Scaffold(
            appBar: AppBar(
              centerTitle: true,
              title: Text(ischos_save ? 'Updat a hall' : 'Add a hall'),
